...
Begin VB.Form frmAsientosErr 
   ...
   Begin VB.CommandButton cmdSaldoHco 
      ...
      Index           =   1
      Left            =   11220
      Picture         =   "frmAsientosErr.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   56
   ...
   Begin VB.CommandButton cmdSaldoHco 
      ...
      Index           =   0
      Left            =   10620
      Picture         =   "frmAsientosErr.frx":6B5C
      Style           =   1  'Graphical
      TabIndex        =   55
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmAsientosErr.frx":D3B5
      Height          =   4455
      Left            =   120
      TabIndex        =   20
      Top             =   2340
   ...
   Begin VB.Frame framelineas 
      ...
      Begin VB.Image Image1 
         ...
         Index           =   2
         Left            =   8580
         Picture         =   "frmAsientosErr.frx":D3CA
         Top             =   180
         Width           =   240
      End
      Begin VB.Image Image1 
         ...
         Index           =   1
         Left            =   5160
         Picture         =   "frmAsientosErr.frx":DDCC
         Top             =   180
         Width           =   240
      End
      Begin VB.Image Image1 
         ...
         Index           =   0
         Left            =   1980
         Picture         =   "frmAsientosErr.frx":E7CE
         Top             =   180
         Width           =   240
      End
   ...
   Begin VB.Image imgppal 
      ...
      Index           =   2
      Left            =   7920
      Picture         =   "frmAsientosErr.frx":F1D0
      Top             =   600
      Width           =   240
   End
   Begin VB.Image imgppal 
      ...
      Index           =   1
      Left            =   3960
      Picture         =   "frmAsientosErr.frx":F2D2
      Top             =   600
      Width           =   240
   End
   Begin VB.Image imgppal 
      ...
      Index           =   0
      Left            =   2040
      Picture         =   "frmAsientosErr.frx":FCD4
      Top             =   600
      Width           =   240
   End
   Begin VB.Label Label1 
...
Dim Aux As String
    On Error GoTo EInsertaEnDiario
        ...
        Aux = "numdiari,fechaent,numasien,linliapu,codmacta,numdocum,codconce,ampconce,timporteD,timporteH,codccost,ctacontr,idcontab,punteada"
        
        Aux = "INSERT INTO linapu(" & Aux & ") SELECT " & Aux & " FROM linapue" & SQL
