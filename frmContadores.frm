...
Private Sub Image1_Click()
    Image1.Tag = "Facturación Ajena" & vbCrLf & String(60, "-") & vbCrLf & vbCrLf
    Image1.Tag = Image1.Tag & "Cuando marque esta opcion a la serie de facturas, en el 340 se declarará" & vbCrLf
