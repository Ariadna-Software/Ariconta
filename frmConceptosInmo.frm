...
Begin VB.Form frmConceptosInmo 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   3
      Tag             =   "Años máximo|N|N|0||sconam|perimaxi|||"
      Text            =   "Dat"
      Top             =   5640
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   2
      Tag             =   "Coeficiente máximo|N|N|||sconam|coefimaxi|##0.00||"
      Text            =   "Dato2"
      Top             =   5640
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código concepto|N|N|0|10000|sconam|codconam|0000|S|"
      Text            =   "Dat"
      Top             =   5640
      Width           =   800
   End
...
Private Sub CargaGrid(Optional SQL As String)
    ...
    I = 2
        DataGrid1.Columns(I).Caption = "Coef. Máx"
