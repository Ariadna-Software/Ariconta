...
Begin VB.MDIForm frmPpal 
   ...
   Begin VB.Menu mnDiario 
      ...
      Begin VB.Menu mnbarra6 
         ...
         Index           =   0
      End
      Begin VB.Menu mnASientosConErrores 
   ...
   Begin VB.Menu mnMenuIVA 
      ...
      Begin VB.Menu mnClientes 
         ...
         End
         Begin VB.Menu mnFacErrCli 
            Caption         =   "Facturas erróneas"
         End
      End
   ...
   Begin VB.Menu mnUtilidades 
      ...
      Begin VB.Menu mnTraspasos 
         ...
         Begin VB.Menu mnTraspasoEntreSecciones 
            ...
            Index           =   1
         End
         Begin VB.Menu mnImportarFacturaTipo 
            Caption         =   "-"
            Index           =   0
         End
         Begin VB.Menu mnImportarFacturaTipo 
            Caption         =   "Facturas consum"
            Index           =   1
         End
      End
      ...
      Begin VB.Menu mnbarra11 
         Caption         =   "-"
      End
      Begin VB.Menu mnComprobarPendientes 
         Caption         =   "Comprobar carpeta integraciones"
      End
...
Private Sub MDIForm_Load()
    ...
    GetIconsFromLibrary App.path & "\icoconppal.dll", 1, 24
...
Dim Config As Boolean
    ...
    mnImportarFacturaTipo(0).visible = vParam.ImportarFacturasProv > 0
    mnImportarFacturaTipo(1).visible = vParam.ImportarFacturasProv > 0
...
Private Sub mnASientosConErrores_Click()
    Screen.MousePointer = vbHourglass
    frmAsientosErr.DesdeNorma43 = 0
    frmAsientosErr.Show vbModal
    ValoresIntegraciones 3
    Screen.MousePointer = vbDefault
End Sub
...
Private Sub mnComprobarPendientes_Click()
    Screen.MousePointer = vbHourglass
    Toolbar1.Buttons(19).visible = BuscarIntegraciones(False, Format(vEmpresa.codempre, "00"))
    ValoresIntegraciones 0 'Todo
    Screen.MousePointer = vbDefault
End Sub
...
Private Sub mnFacErrCli_Click()
    frmFacturasErr.Show vbModal
    ValoresIntegraciones 4
    Screen.MousePointer = vbDefault
End Sub

Private Sub mnFactErrProv_Click()
    Screen.MousePointer = vbHourglass
    frmFacturProvErr.Show vbModal
    ValoresIntegraciones 5
    Screen.MousePointer = vbDefault
End Sub
...
Private Sub mnImportarFacturaTipo_Click(Index As Integer)
...
'
    ...
    Case 19
        frmListIntegracione.Errores = False
        frmListIntegracione.Show vbModal
        'Comprobamos si han eliminardo
        TieneIntegracionesPendientes = BuscarIntegraciones(False, Format(vEmpresa.codempre, "00"))
        Toolbar1.Buttons(19).visible = TieneIntegracionesPendientes
                   
    Case 20
        'frmListIntegracione.Errores = True
        'frmListIntegracione.Show vbModal
        mnComprobarPendientes_Click
        Toolbar1.Buttons(20).visible = BuscarIntegraciones(True, Format(vEmpresa.codempre, "00"))
    Case 22
        Unload Me
    End Select
End Sub
...
'       1.- Integraciones carpete integra
'       2.- Errores integracion
'       3.- Asientos con errores
'       4.- Facturas clientes con errorres
'       5.- Facturas proveedores con errores
...
Dim SQL As String
    ...
    If Opcion = 0 Or Opcion = 2 Then
        ...
        Me.Toolbar1.Buttons(20).visible = bol
    End If
    HayErrores = HayErrores Or bol
    ...
    If Opcion = 0 Or Opcion = 3 Then
        bol = TienenErrores(1)
        mnASientosConErrores.Checked = bol
        If bol Then SQL = SQL & "CABAPU|"
    End If
    HayErrores = HayErrores Or bol
    ...
    If Opcion = 0 Or Opcion = 4 Then
        bol = TienenErrores(2)
        Me.mnFacErrCli.Checked = bol
        If bol Then SQL = SQL & "FRACLI|"
    End If
    HayErrores = HayErrores Or bol
    
    If Opcion = 0 Or Opcion = 5 Then
        bol = TienenErrores(3)
        Me.mnFactErrProv.Checked = bol
        If bol Then SQL = SQL & "FRAPRO|"
    End If
    HayErrores = HayErrores Or bol
