...
Begin VB.Form frmFacturProv 
   ...
   Begin VB.Frame framecabeceras 
      ...
      Top             =   600
      Width           =   11895
      Begin VB.ComboBox cboTipoFac 
         Height          =   315
         ItemData        =   "frmFacturasProv.frx":6852
         Left            =   6960
         List            =   "frmFacturasProv.frx":6862
      ...
      Begin VB.Image imgppal 
         ...
         Index           =   7
         Left            =   4920
         Picture         =   "frmFacturasProv.frx":68A6
         Top             =   720
         Width           =   240
      End
      Begin VB.Label Label1 
      ...
      Begin VB.Image imgppal 
         ...
         Index           =   1
         Left            =   960
         Picture         =   "frmFacturasProv.frx":69A8
         Top             =   120
         Width           =   240
      End
      Begin VB.Image imgppal 
         ...
         Index           =   0
         Left            =   5280
         Picture         =   "frmFacturasProv.frx":6A33
         Top             =   120
         Width           =   240
      End
      Begin VB.Label Label1 
      ...
      Begin VB.Image imgppal 
         ...
         Index           =   2
         Left            =   7080
         Picture         =   "frmFacturasProv.frx":6ABE
         Top             =   120
         Width           =   240
      End
      Begin VB.Label Label1 
      ...
      Begin VB.Image imgppal 
         ...
         Index           =   3
         Left            =   3705
         Picture         =   "frmFacturasProv.frx":74C0
         Top             =   1800
         Width           =   240
      End
      Begin VB.Image imgppal 
         ...
         Index           =   4
         Left            =   3705
         Picture         =   "frmFacturasProv.frx":7EC2
         Top             =   2310
         Width           =   240
      End
      Begin VB.Image imgppal 
         ...
         Index           =   5
         Left            =   3705
         Picture         =   "frmFacturasProv.frx":88C4
         Top             =   2880
         Width           =   240
      End
      Begin VB.Line Line1 
      ...
      Begin VB.Image imgppal 
         ...
         Index           =   6
         Left            =   3675
         Picture         =   "frmFacturasProv.frx":92C6
         Top             =   3870
         Width           =   240
      End
      Begin VB.Label Label2 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFacturasProv.frx":9CC8
      Height          =   2175
      Left            =   1680
      TabIndex        =   38
      Top             =   4920
...
'Para cuando pinta el tipo de iva, ver que tipodiva es:
' 0-IVA 1-IGIC  2-Bien de inversión 3.- REA(Regimen especial agrario) 4.- NO DEDUCIBLE    5.- Importacion
Dim AuxIva As String
...
Private Sub cboTipoFac_Click()
  If Modo = 4 Then
        SQL = ""
        '0.OK    1.- Antes sujet pasivo   2.- Ahora sujeto pasivo
        If data1.Recordset!extranje = 3 Then
            I = 3
            If cboTipoFac.ListIndex <> 3 Then SQL = "tipo anterior sujeto pasivo"
        Else
            I = data1.Recordset!extranje
            If cboTipoFac.ListIndex = 3 Then SQL = "tipo anterior no era sujeto pasivo"
        End If
        If SQL <> "" Then
            MsgBox "Error: " & SQL, vbExclamation
            cboTipoFac.ListIndex = I
        End If
                
    ElseIf Modo = 3 Then
        'INSERTANDO. Cambia el tipo de factura
        If Text1(7).Text <> "" Then Text1_LostFocus 7
        If Text1(13).Text <> "" Then Text1_LostFocus 13
        If Text1(19).Text <> "" Then Text1_LostFocus 19
        
    End If
End Sub

Private Sub cboTipoFac_KeyPress(KeyAscii As Integer)
...
Private Function IntegrarFactura() As Boolean
    ...
    'Sumamos las bases
    Base = 0
    If Not IsNull(data1.Recordset!ba1facpr) Then
        If Val(DevuelveDesdeBD("tipodiva", "tiposiva", "codigiva", data1.Recordset!tp1facpr)) <> 5 Then Base = Base + data1.Recordset!ba1facpr
    End If
    If Not IsNull(data1.Recordset!ba2facpr) Then
        If Val(DevuelveDesdeBD("tipodiva", "tiposiva", "codigiva", data1.Recordset!tp2facpr)) <> 5 Then Base = Base + data1.Recordset!ba2facpr
    End If
    If Not IsNull(data1.Recordset!ba3facpr) Then
        If Val(DevuelveDesdeBD("tipodiva", "tiposiva", "codigiva", data1.Recordset!tp3facpr)) <> 5 Then Base = Base + data1.Recordset!ba3facpr
    End If
    ...
    'Le sumamos los IVAS
    If data1.Recordset!extranje = 3 Then
        'SUJETO PASIVO.  NO suma los IVAS, solo son para contabilizar
        
        
    ElseIf data1.Recordset!extranje = 1 Then
        'Intracomunitarias
        'No sumo los ivas
...
Private Sub Form_Load()
    ...
    'Marzo 2014
    'Check1.Left = ancho
    Me.cboTipoFac.Left = ancho
    Label1(6).Left = ancho
    Me.Check2.Left = cboTipoFac.Left + cboTipoFac.Width + 120
...
Private Sub frmI_DatoSeleccionado(CadenaSeleccion As String)
    AuxIva = RecuperaValor(CadenaSeleccion, 1)
...
'    End If
    ...
    For I = 1 To 3
        ...
        If Text1(kCampo).Text <> "" Then
            SQL = DevuelveDesdeBD("nombriva", "tiposiva", "codigiva", Text1(kCampo).Text, "N", AuxIva)
        Else
            SQL = ""
            AuxIva = ""
        End If
        Text4(I).Text = SQL
        Me.txtTipoDIVA(I).Text = AuxIva
        
        
        'Abril 2015
        'Sujeto PASIVO
        If data1.Recordset!extranje = 3 Then Me.txtTipoDIVA(I).Text = "P"    'Sujeto pasivo. NO sumara los IVAS
...
Private Sub PonerModo(Kmodo As Integer)
    ...
    If B Then Toolbar1.Buttons(8).Enabled = B
    ...
    If Modo = 2 Then Toolbar1.Buttons(10).Enabled = True
...
'    Dim RS As ADODB.Recordset
    ...
    If Modo = 4 Then cboTipoFac_Click
   ...
   If Not B Then
    ...
    'ABril 2015
    If cboTipoFac.ListIndex = 3 Then
        'Inversion del sujeto pasivo.
        'NO DEJO CAMBIAR EL IVA. Con lo cual, base * % es lo que pondre
        
        SQL = ""
        I = 7
        Do
            If Text1(I).Text <> "" Then
                AUX2 = ImporteFormateado(Text1(I + 1).Text)
                Base = ImporteFormateado(Text1(I - 1).Text)
                Aux = ImporteFormateado(Text1(I + 2).Text)
                AUX2 = Round((AUX2 * Base) / 100, 2)
                If AUX2 <> Aux Then SQL = SQL & vbCrLf & "   -" & Text1(I).Text & "  Importe IVA incorrecto (" & AUX2 & " --- " & Aux & ")"
    ...
    Case 10
           ...
           If Modo = 5 Then
                ...
                If CadenaDesdeOtroForm <> "" Then
                    ...
                    SQL = " SELECT max(numlinea) FROM linfactprov WHERE "
                    SQL = SQL & " numregis= " & data1.Recordset!NumRegis & "  AND anofacpr=" & data1.Recordset!anofacpr & ";"
                    ...
                    While Not miRsAux.EOF
                        Linfac = Linfac + 1
                        'numregis,anofacpr,numlinea,codtbase,impbaspr,codccost
                        SQL = SQL & ", (" & data1.Recordset!NumRegis & "," & data1.Recordset!anofacpr
...
Private Function MontaSQLCarga(Enlaza As Boolean) As String
    ...
    SQL = "SELECT linfactprov.codtbase, cuentas.nommacta, linfactprov.codccost, cabccost.nomccost, linfactprov.impbaspr, linfactprov.numlinea"
    SQL = SQL & " FROM (cabccost RIGHT JOIN linfactprov ON cabccost.codccost = linfactprov.codccost) INNER JOIN cuentas ON linfactprov.codtbase = cuentas.codmacta WHERE "
    If Enlaza Then
...
J = ((numero - 1) * 6) + 7
Set RS = New ADODB.Recordset
RS.Open "Select nombriva,porceiva,porcerec,tipodiva from tiposiva where codigiva =" & Text1(J).Text, Conn, adOpenForwardOnly, adLockReadOnly, adCmdText
If RS.EOF Then
    MsgBox "Tipo de IVA incorrecto: " & Text1(J).Text, vbExclamation
    Text1(J).Text = ""
    Text4(numero).Text = ""
    Me.txtTipoDIVA(numero).Text = ""
...
Else
    ...
    Me.txtTipoDIVA(numero).Text = RS!tipodiva
    
    If Me.cboTipoFac.ListIndex = 3 Then
        If RS!tipodiva = 3 Then MsgBox "Inversion de sujeto pasivo  e IVA de importacion.", vbExclamation
        txtTipoDIVA(I).Text = "P" 'NO suma el IVA SUJETO PASIVO
    End If
...
Private Sub TotalesBase()
    ...
    For I = 1 To 3
        If Text1(I * 6).Text <> "" Then
                ...
                'El iVA de importacion NO suma la base
                If Me.txtTipoDIVA(I).Text <> "5" Then
...
Private Sub TotalesIVA()
    ...
    For I = 1 To 3
        ...
        If Text1(ancho).Text <> "" Then
            ...
            'inversion de sujeto pasivo NOOOOOOO
            If Me.txtTipoDIVA(I).Text <> "P" Then
...
Private Sub TotalFactura()
    ...
    For I = 0 To 2
        ...
        Else
            ...
            'Febrero 2016
            'Si es intacomunitario NO sumo el IVA
            'Intracomunitarias NO le sumo el IVA al tota
            ' i=1 o i=2  los ivas
            If I > 0 And cboTipoFac.ListIndex = 1 Then Base = 0
