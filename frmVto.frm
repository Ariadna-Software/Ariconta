...
Private Sub imgFPago_Click(Index As Integer)
    CadenaDesdeOtroForm = ""
    'LlamaBuscaGrid()
    CamposBuscaGrid = "Formas de Pago|sforpa|"
    'Los campos Desc|campo|N|10·"
    ...
    If txtCta(Index).Text <> "" Then
        ...
        Else
            ...
            If CuentaCorrectaUltimoNivel(CamposBuscaGrid, Devuelve) Then
                ...
                CamposBuscaGrid = DevuelveDesdeBD("codmacta", "ctabancaria", "codmacta", txtCta(Index).Text, "T")
...
Private Sub txtPago_LostFocus(Index As Integer)
    ...
    If txtPago(Index).Text <> "" Then
        ...
        Else
            SQL = "tipforpa"
            Campos = DevuelveDesdeBD("nomforpa", "sforpa", "codforpa", txtPago(Index).Text, "N", SQL)
            If Campos <> "" Then
                Devuelve = Campos
                If Opcion = 0 Then
