...
Begin VB.Form frmLiqIVA2 
   ...
   Begin VB.ComboBox Combo1 
      Height          =   315
      ItemData        =   "frmLiqIVA300.frx":030A
      Left            =   7200
      List            =   "frmLiqIVA300.frx":0317
   ...
   End
   Begin VB.Label Label3 
      Caption         =   "INVERSION SUJETO PASIVO"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
...
'            End If
    ...
    Case 3, 4
            ...
            If GenerarFicheroIVA_303_2014(CadenaImportes, CCur(Text1(36).Tag), CDate(FechaIMP), Periodo, Es_A_Compensar, Cad) Then
...
Private Sub PonDatosIVA()
    ...
    'IVA deducible en EXTRANJERO
    Cad = "select sum(bases),sum(ivas) from Usuarios.zliquidaiva where codusu=" & vUsu.Codigo
    Cad = Cad & " and cliente= 7"  'Extranjero
    miRsAux.Open Cad, Conn, adOpenForwardOnly, adLockPessimistic, adCmdText
    If Not miRsAux.EOF Then
        Text1(23).Text = PonerValorImporte(0)
        Text1(24).Text = PonerValorImporte(1)
    End If
    miRsAux.Close
    ...
    'IVA deducible en EXTRANJERO
    Cad = "select sum(bases),sum(ivas) from Usuarios.zliquidaiva where codusu=" & vUsu.Codigo
    Cad = Cad & " and cliente= 8"  'ISP
    miRsAux.Open Cad, Conn, adOpenForwardOnly, adLockPessimistic, adCmdText
    If Not miRsAux.EOF Then
        Text1(45).Text = PonerValorImporte(0)
        Text1(47).Text = PonerValorImporte(1)
    End If
    miRsAux.Close
...
Private Sub SumaDevengado()
    ...
    Importe = Importe + ImporteFormateado(Text1(47).Text)
...
'Cojera los importes y los formateara para los programitas de hacienda
Private Sub GeneraCadenaImportes()
    ...
    'Otras operaciones con inversion del sujeto pasivo
    'Base y cuota
    'Creo que cero
    'Abril 2015.
    'Modificacion de inversion de sujeto pasivo, YA no pintamos un 0
    'Cad = Cad & String(34, "0")
    DevuelveImporte 45, 0   'base
    DevuelveImporte 47, 0  'cuota
    
    'Modificacion bases y cutoas
    'Ni puta idea
    'Cero tb
    Cad = Cad & String(34, "0")
    ...
    'Modificacion bases y cutoas de IVA deducible
    'Continuamos para linea No fucking clue
    'Oootro cero
    Cad = Cad & String(34, "0")
