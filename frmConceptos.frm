...
'    Adodc1.password = vUsu.Passwd
    ...
    'Cadena consulta
    CadenaConsulta = "Select conceptos.codconce,nomconce,conceptos.tipoconce,tipoconceptos.desctipo,"
...
Dim SQL As String
    ...
    If vEmpresa.TieneTesoreria Then
        ...
        SQL = "Select * from stipoformapago where condecli =" & Adodc1.Recordset!codconce
