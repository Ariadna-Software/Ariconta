...
Begin VB.Form frmUtiliBanco 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Image1 
         Height          =   240
         Left            =   840
         Picture         =   "frmUtiliBanco.frx":030A
         Top             =   240
         Width           =   240
      End
   End
...
Dim SQ As String
    ...
    If NF > 0 Then
        SQL = SQ
        SQL = Replace(SQL, " and ", " y ")
        SQL = Replace(SQL, "fecopera", "")
        SQL = Replace(SQL, ">=", "")
        SQL = Replace(SQL, "<=", "")
        SQL = vbCrLf & SQL & vbCrLf & "No deberia seguir con el proceso de importacion" & vbCrLf
        
        SQL = "Se han encontrado datos entre las fechas importadas." & vbCrLf & SQL & vbCrLf & vbCrLf
