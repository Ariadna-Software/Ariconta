...
Begin VB.Form frmListado2 
   ...
   Begin VB.Frame Fr340 
      ...
      Begin VB.ComboBox cmbPeriodo 
         Height          =   315
         Index           =   0
         ItemData        =   "frmListado2.frx":0021
         Left            =   5040
         List            =   "frmListado2.frx":0023
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   1080
         Width           =   1935
      ...
      Begin VB.ListBox List2 
         Height          =   3375
         ItemData        =   "frmListado2.frx":0025
         Left            =   360
         List            =   "frmListado2.frx":0027
         TabIndex        =   14
         Top             =   960
         Width           =   4215
      End
...
Private Sub PonerEmpresaSeleccionEmpresa()
    ...
    RS.Open "Select * from Usuarios.empresas where codempre < 100", Conn, adOpenForwardOnly, adLockOptimistic, adCmdText
...
'Dim Tickets As String
    ...
    End If
    Screen.MousePointer = vbHourglass
    If Modelo340(Me.List2, CInt(txtAno(0).Text), cmbPeriodo(0).ListIndex + 1, Cad, lbl340, Me.chk340(0).Value = 1, Me.cmbPeriodo(1).ListIndex = 1, Me.chk340(1).Value = 1, V340(), UltimoPeriodoLiquidacion) Then
        lbl340.Caption = ""
